...
public class KM {	
    ...
    public static String JOB_NAME = "KM";
        ...
        public void configure(JobConf job) {
            ...
            try {
                ...
                if (cacheFiles != null && cacheFiles.length > 0) {
                    String line;
                    mCenters.clear();
                    BufferedReader cacheReader = new BufferedReader(new FileReader(IN+CENTROID_FILE_NAME));
                    try {
    ...
    public static void run(String[] args) throws Exception {
        ...
        while (isdone == false) {
            JobConf conf = new JobConf(KM.class);
            if (iteration == 0) {
		...
		try
		{
		File fp = new File("/tmp/final.txt");
		...
		String s1 = Double.toString(x1) + "\t --> Low Winning Chances \n";
		bw.write(s1);
		String s2 = Double.toString(x2) + "\t --> Medium Winning Chances \n";
		bw.write(s2);	
		String s3 = Double.toString(x3) + "\t --> High Winning Chances \n";
		bw.write(s3);	
